...
namespace AlexaSkillsKit.Interfaces.InSkillPurchase
{
    public class InSkillProductsClient
    {
        ...
        public InSkillProductsClient(SpeechletRequest request, Context context) : this(request, context, new HttpClient())
        {
            
        }

        public InSkillProductsClient(SpeechletRequest request, Context context, HttpClient client) :
            this(context.System.ApiAccessToken, request.Locale, context.System.ApiEndpoint, client)
        {
